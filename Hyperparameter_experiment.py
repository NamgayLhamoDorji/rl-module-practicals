...
def experiment_learning_rate():
    ...
    plt.tight_layout()
    plt.savefig('rl-practical-2/learning_rate_experiment.png', dpi=300, bbox_inches='tight')
    plt.show()
...
def experiment_discount_factor():
    ...
    plt.tight_layout()
    plt.savefig('rl-practical-2/discount_factor_experiment.png', dpi=300, bbox_inches='tight')
    plt.show()
...
def experiment_epsilon_decay():
    ...
    plt.tight_layout()
    plt.savefig('rl-practical-2/epsilon_decay_experiment.png', dpi=300, bbox_inches='tight')
    plt.show()
